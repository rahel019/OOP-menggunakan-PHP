...
class Produk {
    // Properties
    public $judul,        // Property untuk menyimpan judul produk
           $penulis,      // Property untuk menyimpan nama penulis produk
           $penerbit;     // Property untuk menyimpan nama penerbit produk

    protected $diskon;   // Property untuk menyimpan nilai diskon (protected agar hanya bisa diakses dari kelas turunan)

    private $harga;      // Property untuk menyimpan harga produk (private agar hanya bisa diakses dari kelas itu sendiri)
